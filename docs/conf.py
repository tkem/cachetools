...
htmlhelp_basename = 'cachetoolsdoc'
...
latex_documents = [
    ('index', 'cachetools.tex', u'cachetools Documentation',
...
man_pages = [
    ('index', 'cachetools', u'cachetools Documentation',
     [u'Thomas Kemmer'], 1)
]
...
texinfo_documents = [
    ('index', 'cachetools', u'cachetools Documentation',
     u'Thomas Kemmer', 'cachetools', 'One line description of project.',
     'Miscellaneous'),
]
